...
public class EmployeeControl extends GeneralWindowControl implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        if(LoginControl.get_loggedinEmployee().getPosition_ID().getId() == 2 || LoginControl.get_loggedinEmployee().getPosition_ID().getId() == 3 ||
            ...
            switchToAdmin.getStyleClass().add("switchScene");
        }
...
//
    ...
    public void Open_Add_Pizza(ActionEvent event) throws IOException {
        openScene( "addpizza","GeneralWindowStyle", "Employee/controls","Global_Resources");
    }
    public void Open_Add_Toppings(ActionEvent event) throws IOException {
        openScene( "addtoppings","GeneralWindowStyle", "Employee/controls","Global_Resources");
    }
    public void Open_Add_Promo_Code(ActionEvent event) throws IOException {
        openScene( "addpromocode","GeneralWindowStyle", "Employee/controls","Global_Resources");
    }
    public void Open_Add_Type(ActionEvent event) throws IOException {
        openScene( "addtype","GeneralWindowStyle", "Employee/controls","Global_Resources");
    }
    public void Open_Add_Size(ActionEvent event) throws IOException {
        openScene( "addSize","GeneralWindowStyle", "Employee/controls","Global_Resources");
    }
